	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Edit Keyword'); ?></h1>
			</div>
		</div>
	</div>
					...
					<div class="panel-heading"><?php echo __('Aktionen');?></div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
																...
																<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Löschen'), array('action' => 'delete', $this->Form->value('Keyword.id')), array('escape' => false), __('Sind Sie sicher, dass Sie # %s entfernen wollen?', $this->Form->value('Keyword.id'))); ?></li>
																<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp; Keywords anzeigen'), array('action' => 'index'), array('escape' => false)); ?></li>
